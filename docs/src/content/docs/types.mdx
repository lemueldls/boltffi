...
<TypeTable 
  title="Integers"
  mappings={[
    { rust: "i8", swift: "Int8", kotlin: "Byte" },
    { rust: "i16", swift: "Int16", kotlin: "Short" },
    { rust: "i32", swift: "Int32", kotlin: "Int" },
    { rust: "i64", swift: "Int64", kotlin: "Long" },
    { rust: "u8", swift: "UInt8", kotlin: "UByte" },
    { rust: "u16", swift: "UInt16", kotlin: "UShort" },
    { rust: "u32", swift: "UInt32", kotlin: "UInt" },
    { rust: "u64", swift: "UInt64", kotlin: "ULong" },
  ]}
/>
...
<TypeTable 
  ...
  mappings={[
    { rust: "f32", swift: "Float", kotlin: "Float" },
    { rust: "f64", swift: "Double", kotlin: "Double" },
    { rust: "bool", swift: "Bool", kotlin: "Boolean" },
    { rust: "String", swift: "String", kotlin: "String" },
  ]}
/>

<TypeTable 
  title="Collections & Wrappers"
  mappings={[
    { rust: "Vec<T>", swift: "[T]", kotlin: "List<T>" },
    { rust: "Option<T>", swift: "T?", kotlin: "T?" },
    { rust: "Result<T, E>", swift: "throws", kotlin: "throws" },
  ]}
/>
